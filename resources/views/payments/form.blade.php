        ...
        <div class="flex ml-6 mt-8 main md:flex-col md:ml-4">
            <div class="mr-40 w-max md:w-full md:mr-4">
                <div class="w-max md:w-full">
                    <img class="image-viewer" src="{{ asset('payments/BigImage.png') }}" alt="Current" />
                </div>
                <div class="flex flex-wrap mt-6 gap-4 md:justify-between">
                    <img class="image-viewer" src="{{ asset('payments/image1.png') }}" />
                    <img class="image-viewer" src="{{ asset('payments/image2.png') }}" />
                    <img class="image-viewer" src="{{ asset('payments/image3.png') }}" />
                    <img class="image-viewer" src="{{ asset('payments/image4.png') }}" />
                </div>
            </div>
            <div class="mr-40 md:mr-4">
                ...
                <div class="flex justify-end mb-32 mt-8">
                    <button class="paymentButton">
                        <img src="{{ asset('payments/payment.svg') }}" class="mr-3" />
