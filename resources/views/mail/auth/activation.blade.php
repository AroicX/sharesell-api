                                            ...
                                            <div
                                                ...
                                                <div align="center" class="img-container center autowidth"
                                                    ...
                                                    <div style="font-size:1px;line-height:22px"> </div><img
                                                        ...
                                                        class="center autowidth" src="{{ config('app.url') }}/images/Companify-Logo.png"
                                            ...
                                            <div
                                                ...
                                                <div align="center" class="img-container center fixedwidth"
                                                    ...
                                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 40px;padding-left: 40px;" align="center"><![endif]--><img
                                                        align="center" alt="I'm an image" border="0"
                                                        class="center fixedwidth" src="{{ config('app.url') }}/images/Img4_2x.jpg"
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="font-size: 22px; color: #2b303a;">
                                                                <strong>Welcome {{ $user->first_name }} {{$user->last_name}},
                                                                </strong>
                                                            </span>
                                                            <br>
                                                            <strong style="font-size: 18px; color: #2b303a;">To contiune
                                                                please activate
                                                                your account with the using the link below.</strong>
                                                        </p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
												...
												<div
													...
													<p
														...
														<span style="color: #808389; font-size: 15px;">Lorem ipsum dolor
															sit amet, consectetur adipisicing elit, sed do eiusmodati
															mat tempor incididunt ut labore et dolore magna
															aliqua.</span></p>
												</div>
											</div> --}}
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="color: #2b303a; font-size: 18px;"><strong>Use
                                                                    this
                                                                    Code</strong></span></p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="color: #1aa19c; font-size: 38px;"><span
                                                                    style=""><strong>BEE20</strong></span></span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                                <!--[if (!mso)&(!IE)]><!-->
                                        ...
                                        <div style="width:100% !important;">
                                            ...
                                            <div
                                                ...
                                                <div align="center" class="button-container"
                                                    ...
                                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 40px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:46.5pt; width:168pt; v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]-->
                                                    <div
                                                        ...
                                                        <a href="{{ config('app.url') }}/api/auth/verify/{{ \Crypt::encrypt($user->email)}}"
                                                            style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block; text-decoration: none; color: #fff;"><span
                                                                style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>Activate
                                                                    Code</strong></span></a></div>
                                            ...
                                            <div
                                                ...
                                                <div align="center" class="img-container center autowidth"
                                                    ...
                                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
                                                        align="center" alt="I'm an image" border="0"
                                                        class="center autowidth" src="{{ config('app.url') }}/images/footer.png"
                                                ...
                                                <div align="center" class="img-container center autowidth"
                                                    ...
                                                    <div style="font-size:1px;line-height:40px"> </div><img
                                                        ...
                                                        class="center autowidth" src="{{ config('app.url') }}/images/Logo-white.png"
                                                        style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 149px; display: block;"
                                                                            ...
                                                                            <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 5px; padding-left: 5px;"
                                                                                valign="top"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Facebook"
                                                                                        height="32"
                                                                                        src="{{ config('app.url') }}/images/facebook2x.png"
                                                                            ...
                                                                            <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 5px; padding-left: 5px;"
                                                                                valign="top"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Twitter"
                                                                                        height="32"
                                                                                        src="{{ config('app.url') }}/images/twitter2x.png"
                                                                                        style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                        title="Twitter"
                                                                                        width="32" /></a>
                                                                            </td>
                                                                            <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 5px; padding-left: 5px;"
                                                                                valign="top"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Instagram"
                                                                                        height="32"
                                                                                        src="{{ config('app.url') }}/images/instagram2x.png"
                                                                                        style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                        title="Instagram"
                                                                                        width="32" /></a>
                                                                            </td>
                                                                            <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 5px; padding-left: 5px;"
                                                                                valign="top"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="LinkedIn"
                                                                                        height="32"
                                                                                        src="{{ config('app.url') }}/images/linkedin2x.png"
                                                                                        style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                        title="LinkedIn"
                                                                                        width="32" /></a>
                                                                            </td>
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="color: #95979c; font-size: 12px;">Etiam quis
                                                                tempus
                                                                ex. Sed vitae ipsum suscipit, ultricies odio vitae,
                                                                suscipit
                                                                massa. Sed tempus ipsum eget diam aliquam maximus. Cras
                                                                accumsan urna vel rutrum lobortis. Maecenas tristique
                                                                purus
                                                                vel ex tempor consequat. Curabitur dui massa, congue sed
                                                                sem
                                                                at, rhoncus imperdiet sem. Fusce ac orci fermentum,
                                                                malesuada dolor a, cursus augue. Quisque porttitor
                                                                sapien
                                                                arcu, quis iaculis nisi faucibus eget. Vestibulum eu
                                                                velit
                                                                rhoncus, aliquam ante eget, tristique diam dui massa,
                                                                congue
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <span style="color: #95979c; font-size: 12px;">Companify
