...
<nav class="sidebar">
    <div class="logo d-flex justify-content-between">
        ...
        <a class="small_logo" href="index-2.html"
            ><img src="{{ asset('img/mini_logo.png') }}" alt=""
        /></a>
    ...
    <ul id="sidebar_menu">
        <li>
            <a
                href="{{ url('/administrator/dashboard') }}"
                aria-expanded="false"
            >
                <div class="nav_icon_small">
                    <img
                        src="{{ asset('img/menu-icon/dashboard.svg') }}"
                        alt=""
                    />
                </div>
                <div class="nav_title">
        ...
        <h4 class="menu-text">
            <span>Products</span> <i class="fas fa-ellipsis-h"></i>
        </h4>
        <li class="">
